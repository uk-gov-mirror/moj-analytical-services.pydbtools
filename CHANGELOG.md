...
- Handle blank SQL queries when inferring an Athena database
- Update dependencies and github actions

## v5.8.1 - 2025-05-08

- Amend the new regex pattern for AP Airflow role syntax

## v5.8.0 - 2025-05-07

- Update AWS role regex to allow Analytical Platform [Airflow role syntax](https://user-guidance.analytical-platform.service.justice.gov.uk/services/airflow/index.html#workflow-identity)

## v5.7.1 - 2025-05-07

- update github publish workflow to use `uv`
...
- bump mkdocs-tech-docs-template to fix failing mkdocs build
...
- bump and relax sqlparse dependency
